...
public class FollowSummonerGoal extends Goal {
   ...
   private final DungeonsIronGolemEntity tamable;
   ...
   public FollowSummonerGoal(DungeonsIronGolemEntity pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
