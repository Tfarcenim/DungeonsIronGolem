...
public class SwipeGoal extends Goal {
    ...
    public SwipeGoal(DungeonsIronGolemEntity pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        this.mob = pMob;
    ...
    protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
        ...
        if (inRange) {
            mob.startAnimation(DungeonsIronGolemEntity.GolemAnimation.SWIPE);
